...
import { getMyProjectsApi } from "../_apis/apis";
...
export default function MyProjects() {
    ...
    const { data, isPending, isError } = useQuery({
        ...
        queryFn: () => getMyProjectsApi(page, pageSize),
    });

    if (isPending) return <Spinner />;
    if (isError) return <div className="text-red-500">프로젝트 목록을 불러오는데 실패했습니다.</div>;
    ...
    if (projects.length === 0) {
        return (
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">내가 작성한 프로젝트</h2>
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 text-lg mb-4">아직 작성한 프로젝트가 없습니다.</p>
                    <Link
                        href="/project/create"
    ...
    return (
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl font-bold text-gray-800">내가 작성한 프로젝트</h2>
