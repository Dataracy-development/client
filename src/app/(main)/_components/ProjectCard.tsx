...
export default function ProjectCard() {
    return (
        <Link href="/project/1">
            <div className="h-[570px] bg-white rounded-2xl border border-n500">
                ...
                <div className="px-5 py-[18px]">
                    <div className="text-h5 mb-6">병원 대기시간 예측 모델링을 통한 환자 만족도 개선</div>

                    <div className="text-body2 mb-6">3년간의 고객 구매 데이터를 활용해 RFM 분석과 협업 필터링을 통한 개인화 추천 시스템을 구축했습니다....</div>
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-start">
                            <div className="w-8 flex flex-col justify-center items-center gap-[5px]">
                                ...
                                <div className="text-body2">24</div>
                            </div>
                            <div className="w-8 flex flex-col justify-center items-center gap-[5px]">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="text-body2">156</div>
                            </div>
                            <div className="w-8 flex flex-col justify-center items-center gap-[5px]">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="text-body2">1.2k</div>
                            </div>
                        </div>
                    </div>
                </div>
