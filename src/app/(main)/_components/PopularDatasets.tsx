            ...
            <div className="max-w-[1200px] w-full mx-auto">
                ...
                <div className="mt-10">
                    <div className="flex bg-n900 h-[50px] mb-1">
                        <div className="w-[180px] text-button text-white leading-[50px] text-center">카테고리</div>
                        <div className="w-[500px] pl-2.5 text-button text-white leading-[50px]">데이터셋</div>
