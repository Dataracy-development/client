export default function DatasetRow() {
    return (
        <div className="flex h-[68px] bg-white">
            <div className="w-[180px] pl-4 flex items-center gap-1">
                {[1, 2, 3].map((v) => {
                    return (
            ...
            <div className="w-[500px] pl-2.5 text-button text-n900 flex flex-col justify-center">Title</div>
            <div className="w-[200px] pl-2.5 flex items-center gap-2">
                <div className="bg-gray-200 w-10 h-10 rounded-full"></div>
                <div className="text-button">UserName</div>
            </div>
            <div className="w-[100px] pl-2.5 flex flex-col justify-center text-button text-n900">2025.00.00.</div>
